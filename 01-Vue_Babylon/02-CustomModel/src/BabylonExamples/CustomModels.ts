...
export class CustomModels {
    ...
    CreateScene():Scene {
        ...
        const envTex = CubeTexture.CreateFromPrefilteredData("./textures/skybox/environment.env", scene);
    ...
    async CreateBarrelModel(): Promise<void> {
        ...
        const models = await SceneLoader.ImportMeshAsync("", "./models/barrel/", "barrel.glb");
        models.meshes[0].position = new Vector3(0.0, -1.0, 0.0);
